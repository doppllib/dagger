...
+ (void)initialize {
  if (self == [DaggerInternalSetFactory class]) {
    JreStrongAssignAndConsume(&DaggerInternalSetFactory_EMPTY_FACTORY, new_DaggerInternalSetFactory_$1_init());
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _DaggerInternalSetFactory_$1 = { "", "dagger.internal", ptrTable, methods, NULL, 7, 0x8008, 2, 0, 1, -1, -1, 2, -1 };
...
DaggerInternalSetFactory_$1 *new_DaggerInternalSetFactory_$1_init() {
  J2OBJC_NEW_IMPL(DaggerInternalSetFactory_$1, init)
}

DaggerInternalSetFactory_$1 *create_DaggerInternalSetFactory_$1_init() {
  J2OBJC_CREATE_IMPL(DaggerInternalSetFactory_$1, init)
}
